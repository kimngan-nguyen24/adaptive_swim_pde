...
from .utils import compute_interpolation_points, find_nearest_indices
from adaptive_swim.activation import TorchActivation
from adaptive_swim.adaptive_solver import AdaptiveSolver
...
class Dense(Base):
    ...
    def fit_adaptive(self, x: npt.NDArray, y: npt.NDArray) -> Dense:
        ...
        if self._model is not None:
            ...
            params = self.adaptive_solver.compute_a_params(
                model=self._model,
                x_points=x_inter,
                y_points=y_inter,
                w=w,
