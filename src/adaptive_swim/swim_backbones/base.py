...
class Base(BaseEstimator, ABC):
    ...
    a_params: npt.NDArray | None = None
    ...
    @staticmethod
    def identity_activation(x: npt.NDArray, _: npt.NDArray) -> npt.NDArray:
    ...
    @staticmethod
    def relu_activation(x: npt.NDArray, _: npt.NDArray) -> npt.NDArray:
    ...
    @staticmethod
    def tanh_activation(x: npt.NDArray, _: npt.NDArray) -> npt.NDArray:
    ...
    def transform(self, x: npt.NDArray, _: npt.NDArray | None = None) -> npt.NDArray:
        ...
        x = self.prepare_x(x)
        return self.activation(x @ self.weights + self.biases, self.a_params)
